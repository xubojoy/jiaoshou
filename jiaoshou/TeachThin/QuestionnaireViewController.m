...
- (void)viewDidLoad
{
    ...
    _Arr = [[NSArray alloc]initWithObjects:@"汉族",@"壮族",@"满族",@"回族",@"苗族",@"维吾尔族",@"土家族",@"彝族",@"蒙古族",@"藏族",@"布依族",@"朝鲜族",@"瑶族",@"其它", nil];
    _Arr1 = [[NSArray alloc]initWithObjects:@"小学",@"初中",@"高中",@"大专",@"本科",@"研究生",@"硕士",@"博士",@"其它", nil];
    [self setlayout];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    switch (indexPath.section) {
        case 0:
        {
            self.cas = [[CustomActionSheet alloc] initWithView:nil AndHeight:250];
            ...
            self.pv.tag = 1000;
            [self.pv selectRow:0 inComponent:0 animated:YES];
