...
- (void)setMessageFrame:(MessageFrame *)messageFrame{
    ...
    // 2、设置头像
    [_iconView setImageWithURL:[NSURL URLWithString:message.icon]];// [UIImage imageNamed:message.icon];
    ...
    if (message.type == MessageTypeMe) {
        ...
        normal = [UIImage imageNamed:@"talkImg2.png"];
        normal = [normal stretchableImageWithLeftCapWidth:normal.size.width * 0.5 topCapHeight:normal.size.height * 0.7];
        focused = [UIImage imageNamed:@"talkImg2.png"];
        focused = [focused stretchableImageWithLeftCapWidth:focused.size.width * 0.5 topCapHeight:focused.size.height * 0.7];
    }else{
        
        normal = [UIImage imageNamed:@"talkImg1"];
        normal = [normal stretchableImageWithLeftCapWidth:normal.size.width * 0.5 topCapHeight:normal.size.height * 0.7];
        focused = [UIImage imageNamed:@"talkImg1"];
        focused = [focused stretchableImageWithLeftCapWidth:focused.size.width * 0.5 topCapHeight:focused.size.height * 0.7];
