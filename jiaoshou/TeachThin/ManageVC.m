...
+(ManageVC*)sharedManage
{
    if (manage==nil) {
        ...
        manage.userImg = [[NSUserDefaults standardUserDefaults] valueForKey:@"userimg"];
        manage.niceName = [[NSUserDefaults standardUserDefaults] valueForKey:@"nick"];
        manage.userNameArr = [[NSUserDefaults standardUserDefaults] valueForKey:@"userNameArr"];
    }
    return manage;
}
