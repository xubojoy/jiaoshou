...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath;
{
    ...
    if(indexPath.section==0&&_isDone==YES){
        titleLable.text = [NSString stringWithFormat:@"医生建议 %@",[_DataDict valueForKey:@"infor"]];
        
    }else if (indexPath.section==1&&_isDone==YES){
        ...
        [str1 addAttribute:NSFontAttributeName value:[UIFont fontWithName:@"HelveticaNeue-Bold" size:18.0] range:NSMakeRange(4, str1.length-4)];
        titleLable.attributedText = str1;

    }else if ((indexPath.section==2&&_isDone==YES) || (indexPath.section==0&&_isDone==NO)){
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    if((section==2&&_isDone==YES) || (section==0&&_isDone==NO)){
