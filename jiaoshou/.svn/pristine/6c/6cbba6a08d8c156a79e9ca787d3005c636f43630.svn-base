    ...
    reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _unreadLabel = [[UILabel alloc] initWithFrame:CGRectMake(285, 30, 25, 25 )];
        _unreadLabel.backgroundColor = [UIColor redColor];
        _unreadLabel.textColor = [UIColor whiteColor];
        
        _unreadLabel.textAlignment = NSTextAlignmentCenter;
        _unreadLabel.font = [UIFont systemFontOfSize:11];
        [_unreadLabel.layer setCornerRadius:_unreadLabel.frame.size.width/2];
        ...
        _lineView = [[UIView alloc] initWithFrame:CGRectMake(70, 60-0.5, VIEW_WEIGHT-70, 0.5)];
