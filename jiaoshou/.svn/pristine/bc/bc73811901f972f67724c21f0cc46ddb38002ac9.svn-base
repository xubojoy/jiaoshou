...
+(NSString*)GetLunarDateTime{
    GXCalendar* date = [[GXCalendar alloc]init];
    date.year = [[self GetYear:[NSDate date]] intValue],date.month =[[self GetMonth:[NSDate date]] intValue],date.day = [[self GetDay:[NSDate date]] intValue];
...
+(NSString *)GetYear:(NSDate *)Date{
    ...
    NSString* date = [[NSString alloc]initWithString:[formatter stringFromDate:Date]];
    return date;
}
